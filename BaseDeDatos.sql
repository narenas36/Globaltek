...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2021 a las 23:09:00
...
CREATE TABLE `citas` (
  ...
  `animal` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `consulta` enum('salud','higiene') COLLATE utf8_unicode_ci DEFAULT NULL
